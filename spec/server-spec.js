...
describe("Blog Server with Database Interaction", () => {
  ...
  beforeEach(function (done) {
    ...
    var tablename = "posts"; // TODO: fill this out
  ...
  describe("Should output all posts from the DB", () => {
    ...
    it("it should GET all records stored in the database table", (done) => {
      ...
      let queryString = `INSERT INTO posts (id, title, body, users_user_id) VALUES (?);
      INSERT INTO posts (id, title, body, users_user_id)VALUES (?);
      INSERT INTO posts (id, title, body, users_user_id) VALUES (?);`;

      //TODO - provide example values matching respective field types
      let queryArgs = [[1,"first blog","hello",2], [2,"second blog","good bye",3], [3,"third blog","good job",1]];
        ...
        chai
          ...
          .end((err, res) => {
            ...
            res.body.forEach((element) => {
              ...
              element.should.have.property("title").that.is.oneOf(["first blog", "second blog", "third blog"]);
            });
            done();
          });
      });
